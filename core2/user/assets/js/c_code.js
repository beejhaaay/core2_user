...
document.getElementById("click_button").addEventListener("click", function click_button() {
    ...
    async function getDestinationName() {
      ...
      location.href = "next_page.php?position=" + pickup + "&distance=" + distance + "&duration=" + duration + "&destination=" + json.features[0].text + "&destination_address=" + json.features[0].properties.address;
    }
    getDestinationName();
  });
