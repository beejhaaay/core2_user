...
?>
        ...
        <h4 class="table table-hover"><em><b>Driver Name:</b> </h4>     
     <h4 class="table table-hover"><em><b>Age:</b>  </h4>
       <h4 class="table table-hover"><em><b>Contact No.:</b>   </h4>     
     <h4 class="table table-hover"><em><b>Gender:</b>  </h4>
...
<hr style="border-top: 2px dashed black;color:transparent;"/>
   ...
   <h4 class="table table-hover"><b>Total:</b> ₱<?php  echo $total_cost; ?> </em></h4>
                ...
                <center><a href="booking.php"><input type="submit" name="submit" id="submit" value="Proceed" disabled style="margin-bottom: -20px; margin-top: 20px; background-color: #0d6efd; width: 100%; height: 7vh;"  /></a> </center>
